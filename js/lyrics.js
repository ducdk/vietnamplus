...
const iconplay =  ($(window).width() > 768) ? document.getElementById('iconplay') : document.getElementById('iconplay1');
const iconpause = ($(window).width() > 768) ? document.getElementById('iconpause') : document.getElementById('iconpause1');
